...
<div class="space-y-6">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-800 md:text-3xl">Tambah User Baru</h1>
            <p class="mt-1 text-sm text-slate-500">Buat akun baru untuk akses sistem admin.</p>
        </div>
