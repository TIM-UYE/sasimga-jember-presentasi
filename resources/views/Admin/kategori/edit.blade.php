...
<div class="space-y-6">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-slate-800 md:text-3xl">Edit Kategori Menu</h1>
                    <p class="mb-0 text-sm text-slate-500">Perbarui kategori agar tetap relevan dengan daftar menu.</p>
                </div>
