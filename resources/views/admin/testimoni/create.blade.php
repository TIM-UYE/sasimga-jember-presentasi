...
<div class="space-y-6">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-slate-800 md:text-3xl">Tambah Testimoni</h1>
                    <p class="mb-0 text-sm text-slate-500">Masukkan ulasan pelanggan untuk meningkatkan kepercayaan pengunjung.</p>
                </div>
                ...
                <form action="{{ route('admin.testimoni.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="mb-4 md:col-span-2">
                            ...
                            <textarea name="text" id="text" rows="4"
                                class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-200"
                                placeholder="Masukkan isi testimoni..." required>{{ old('text') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4 md:col-span-2">
                            ...
                            <input type="url" name="profile_photo_url" id="profile_photo_url" value="{{ old('profile_photo_url') }}"
                                class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-200"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="author_url" id="author_url" value="{{ old('author_url') }}"
                                class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-200"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="language" id="language" value="{{ old('language', 'id') }}"
                                class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-200"
                                placeholder="id">
                        </div>
                    ...
                    <div class="mt-6 flex gap-3 border-t border-slate-100 pt-5">
                        ...
                        <button type="submit" class="btn-admin">
                            <i class="fas fa-save mr-1"></i> Simpan Testimoni
                        </button>
                    </div>
                </form>
    </div>
